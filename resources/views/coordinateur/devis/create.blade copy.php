            ...
            <div class="card invoice-preview-card">
                ...
                <div class="card-body invoice-padding pt-0">
                    <div class="row row-bill-to invoice-spacing">
                        <div class="col-8">
                            ...
                            <div class="invoice-customer">
                                <select class="form-control" id="receiver_id" name="receiver_id">
                                    <option value="{{$destinataire->id}}">{{$destinataire->prenom}} {{$destinataire->nom}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-12">
                            <input class="form-control" value="{{$id_demande_cons}}" id="demande_cons_id" name="demande_cons_id" hidden />
                        </div>
                        <div class="col-12">
