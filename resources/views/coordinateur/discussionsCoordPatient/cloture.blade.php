...
<div class="row">
    <div class="col-lg-2 col-3">
        <ul class="timeline">
            ...
            <a href="{{url('coordinateur/discussionsCoordPatient/cloture')}}" class="list-group-item list-group-item-action active">
            ...
            <div class="card mt-1">
                <div class="card-header row">
                    <div class="col-9">
                        ...
                        <img src="{{asset('uploads/users/'.($d->destinataire->image??'user.png')) }}" height="30" width="30" alt="avatar img holder" />
