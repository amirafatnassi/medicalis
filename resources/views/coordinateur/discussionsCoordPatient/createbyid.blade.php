...
<div class="row">
    <div class="col-lg-2 col-3">
        <ul class="timeline">
            <a href="{{url('coordinateur/discussionsCoordPatient/create')}}" class="list-group-item list-group-item-action active">
        ...
        <div class="list-group list-group-labels">
            ...
            <ul class="timeline">
                <a href="{{url('coordinateur/discussionsCoordPatient/createbyid/'.$m->id)}}" class="list-group-item list-group-item-action">
    ...
    <div class="col-lg-10 col-9">
        <form method="POST" action="{{url('coordinateur/discussionsCoordPatient/store')}}" enctype="multipart/form-data"> @csrf
            <div class="card">
