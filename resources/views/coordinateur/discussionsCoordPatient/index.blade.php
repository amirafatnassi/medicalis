        ...
        <ul class="timeline">
            ...
            <div class="card mt-1">
                <div class="card-header row">
                    <div class="col-9">
                        @if ($d->M_P=="M")
                        <img src="{{asset('uploadscoordinateur/'.($d->emetteur->image??'user.png'))}}" class="round" height="30" width="30" alt="" />
                        ...
                        {{$d->emetteur->prenom}} {{$d->emetteur->nom}}
                        <i data-feather="arrow-right"></i>
                        <img src="{{asset('uploadscoordinateur/'.($d->destinataire->image??'user.png'))}}" class="round" height="30" width="30" alt="" />
                        {{$d->destinataire->prenom}} {{$d->destinataire->nom}}
                        @endif
                    </div>
                    <div class="col-3">
