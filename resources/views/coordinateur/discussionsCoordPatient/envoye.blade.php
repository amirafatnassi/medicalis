...
<div class="row">
    <div class="col-lg-2 col-3">
        <ul class="timeline">
            ...
            <a href="{{url('coordinateur/discussionsCoordPatient/envoye')}}" class="list-group-item list-group-item-action active">
        ...
        <div class="card mt-1">
            ...
            <div class="card-body">
                <h3>
                    ...
                    <a href="{{url('coordinateur/discussionsCoordPatient/show',['slug'=>$discussion->slug])}}">
