...
<form method="POST" action="{{url('coordinateurChef/dossiers/examenradios/update/'.$examenradio[0]->id)}}" enctype="multipart/form-data"> @csrf
    <div class="row">
        <div class="col-12">
            <h5 class="blueLabel">
...
<script>
    ...
    function deleteData(id) {
        var id = id;
        var url = '{{route("coordinateurChef.dossiers.examenradios.deleteFile",":id")}}';
