...
<div class="row">
    ...
    <div class="col-2">
        <a href="{{url('coordinateurChef/dossiers/'.$dossier->id.'/examenradios/create')}}" class="btn btn-outline-success">Nouveau examen radio</a>
    </div>
    <div class="col-6">
    ...
    <div class="col-12">
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    <td style="width:9%"><a href="{{url('coordinateurChef/dossiers/examenradios/show/'.$examenradio->id)}}" class="btn btn-primary">ID:{{$examenradio->id}}</a></td>
                    ...
                    <td style="width:10%">@if(($examenradio->downloads)!==0)
                        <a href="{{url('coordinateurChef/dossiers/examenradios/showExamenfiles/'.$examenradio->id)}}"><i data-feather="paperclip"></i></a>
                        @endif
                    </td>
