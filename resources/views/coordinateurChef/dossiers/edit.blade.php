            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column nav-left">
                        <!-- personal -->
                        <li class="nav-item">
                            <a class="nav-link active" id="account-pill-personal" data-toggle="pill" href="#account-vertical-general" aria-expanded="true">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-personal" aria-labelledby="account-pill-personal" aria-expanded="true">
                                    ...
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="post" action="{{url('coordinateurChef/dossiers/update_personal/'.$dossier->id)}}" enctype="multipart/form-data"> @csrf
                                        <div class="row">
                                            <div class="col-4">
                                ...
                                <div role="tabpanel" class="tab-pane" id="account-vertical-adress" aria-labelledby="account-pill-adress" aria-expanded="true">
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="post" action="{{url('coordinateurChef/dossiers/update_adress/'.$dossier->id)}}" enctype="multipart/form-data"> @csrf
                                        <div class="row">
                                            <div class="col-4">
                                ...
                                <div class="tab-pane fade" id="account-vertical-general" role="tabpanel" aria-labelledby="account-pill-general" aria-expanded="false">
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="post" action="{{url('coordinateurChef/dossiers/update_general/'.$dossier->id)}}" enctype="multipart/form-data"> @csrf
                                        <div class="row">
                                            <div class="col-6">
                                ...
                                <div class="tab-pane fade" id="account-vertical-medical" role="tabpanel" aria-labelledby="account-pill-medical" aria-expanded="false">
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="post" action="{{url('coordinateurChef/dossiers/update_medical/'.$dossier->id)}}" enctype="multipart/form-data"> @csrf
                                        <div class="row">
                                            <div class="col-12">
                                ...
                                <div class="tab-pane fade" id="account-vertical-files" role="tabpanel" aria-labelledby="account-pill-files" aria-expanded="false">
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="post" action="{{url('coordinateurChef/dossiers/update_files/'.$dossier->id)}}" enctype="multipart/form-data"> @csrf
                                        <div class="col-12">
