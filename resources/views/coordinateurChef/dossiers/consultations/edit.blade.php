...
<form method="POST" action="{{url('coordinateurChef/dossiers/consultations/update/'.$consultation->id)}}" enctype="multipart/form-data"> {{csrf_field()}}
    <div class="row">
        <div class="col-12">
            <h5>
                <center><u>Modifier consultation:</center></u>
            </h5>
        </div>
        <div class="col-6">
        ...
        <div class="col-6">
            ...
            <select class="form-control" name="id_medecin" id="id_medecin">
                <option value="{{$consultation->id_medecin}}">{{$consultation->med}}</option>
        ...
        <div class="col-6">
            ...
            <select class="form-control" name="motif" id="motif">
                <option value="{{$consultation->id_motif}}">{{$consultation->motif}}</option>
                @foreach ($liste_motif as $list_motif)
...
@foreach($files as $f)
<div class="row">
    <a href="{{url('/uploads/consultation/'.$f->downloads)}}">
...
<script>
    ...
    function deleteData(id) {
        var id = id;
        //alert (id);
        var url = '{{route("coordinateurChef.dossiers.consultations.deleteFile",":id")}}';
