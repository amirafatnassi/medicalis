            ...
            <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                <div class="user-avatar-section">
                    <div class="d-flex justify-content-start">
                        <img class="img-fluid rounded" src="{{asset('uploads/dossier/'.$dossier->image)}}" height="104" width="104" alt="avatar" />
...
<ul class="timeline">
    ...
    <div>{!!$consultation->observation!!}</div>
    @if(!$files->isEmpty())
    ...
    @endforeach
    @endif
    @if(!is_null($consultation->observation_prive)&&($consultation->id_medecin==Auth::user()->id) || (Auth::user()->id == $consultation->created_by))
    <div class="row">
        <b style="color:red"><u>Observation privée: </u></b>
        <small>( affiché pour vous uniquement ):</small>
    </div>
    <div>{!!$consultation->observation_prive!!}</div>
    @endif
    ...
    <div>{!!$consultation->effet_marquant_txt!!}</div>
    @endif
...
<div class="row">
    ...
    <div class="col-6"> <a href="{{url('coordinateurChef/dossiers/consultations/edit/'.$consultation->id)}}" class="btn  btn-block btn-primary">
            <i data-feather="edit" class="mr-1"></i> Modifier consultation
        </a></div>
    @endif
    <div class="col-6">
        <a href="{{url('coordinateurChef/dossiers/consultations/imprimer/'.$consultation->id)}}" class="btn  btn-block btn-primary">
