...
<div class="row">
    ...
    <div class="col-2">
        <div class="row">
            <div>
                <a href="{{url('coordinateurChef/dossiers/'.$id_dossier.'/monHistorique')}}" class="btn btn-primary">Mon historique</a>
            </div>
            <div>&nbsp;</div>
            <div>
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="plus-circle"></i></button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{url('coordinateurChef/dossiers/'.$id_dossier.'/consultations/create')}}">Consultation</a>
                        <a class="dropdown-item" href="{{url('coordinateurChef/dossiers/'.$id_dossier.'/examenbios/create')}}">Examen Bio</a>
                        <a class="dropdown-item" href="{{url('coordinateurChef/dossiers/'.$id_dossier.'/examenradios/create')}}">Examen Radio</a>
                    </div>
                </div>
            </div>
        </div>
