        ...
        <div class="row">
                        ...
                        <div class="card profile-header mb-2">
                            <div class="position-relative">
                                <div class="profile-img-container d-flex align-items-center">
                                    <img class="rounded img-fluid" alt="Card image" src="{{asset('uploads/dossier/'. $dossier->image)}}">
                                </div>
                            </div>

                            <div class="row">
                                <a href="{{ url('coordinateurChef/dossiers/'.$dossier->id.'/effetsmarquants')}}" class="btn btn-outiline-primary">
                                    <i data-feather='archive'></i>
                                </a>
                                <a href="{{url('coordinateurChef/forumMedPatient/createbyid/'.$dossier->id)}}" class="btn btn-outiline-primary">
                                    <i data-feather="message-square"></i>
                                </a>
                                <a href="{{ url('coordinateurChef/dossiers/'.$dossier->id.'/historiques')}}" class="btn btn-outiline-primary">
                                    <i data-feather="clock" class="mr-50"></i>
                                </a>
                                <a class="btn btn-outiline-primary" href="{{url('coordinateurChef/dossiers/edit/'.$dossier->id)}}">
            ...
            <div class="col-lg-6 col-12 order-1 order-lg-2">
                 ...
                 <div class="card">
                    <div class="card-body">
                        <center>
                            <a href="{{ url('coordinateurChef/dossiers/'.$dossier->id.'/consultations/index')}}" class="btn btn-outline-secondary"><i data-feather="clipboard"></i> Consultations</a>
                            <a href="{{ url('coordinateurChef/dossiers/'.$dossier->id.'/examenbios/index')}}" class="btn btn-outline-secondary"><i data-feather="clipboard"></i> Examen bio</a>
                            <a href="{{ url('coordinateurChef/dossiers/'.$dossier->id.'/examenradios/index')}}" class="btn btn-outline-secondary"><i data-feather="clipboard"></i> Examen radio</a>
                        </center>
                    </div>
                </div>
                <!--/ post 1 -->
