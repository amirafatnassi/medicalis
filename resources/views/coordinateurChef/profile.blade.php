                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                    ...
                                    <!-- form -->
                                    <form class="validate-form mt-2" method="POST" action="{{url('coordinateurChef/update_general')}}" enctype="multipart/form-data"> {{csrf_field()}}
                                        <div class="row">
                                ...
                                <div class="tab-pane fade" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                    <!-- form -->
                                    <form class="validate-form" method="post" action="{{url('coordinateurChef/updatemdp')}}"> @csrf
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                                    <!-- form -->
                                    <form class="validate-form" method="POST" action="{{url('coordinateurChef/update_information')}}" enctype="multipart/form-data"> {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-6">
                                                <label for="motif"><b>Sexe:</b></label>
                                                <select class="form-control" name="sexe_id" id="sexe_id">
                                                    <option value="{{$user->sexe_id}}">{{$user->sexe}}</option>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select id="pays" name="pays" class="form-control" required>
                                                    <option value="{{$user->country_id}}">{{$user->pays}}</option>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="state" id="state" class="form-control" required>
                                                        <option value="{{$user->ville_id}}">{{$user->ville}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-4">
