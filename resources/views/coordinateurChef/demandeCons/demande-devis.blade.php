...
<div class="card user-card">
    ...
    <form method="POST" action="{{url('coordinateurChef/demandeDevis/store')}}" enctype="multipart/form-data"> {{csrf_field()}}
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input class="form-control" type="text" name="objet" value="{{old('objet')}}">
