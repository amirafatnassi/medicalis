            ...
            <tr class="fw-normal">
                ...
                <td class="border-0 align-middle">
                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="{{url('patient/prendre-en-charge/'.$notification->id.'/'.$notification->data['demande'])}}" enctype="multipart/form-data"> {{csrf_field()}}
                        ...
                        <a class="btn btn-link" type="submit" href="{{url('patient/demandeCons/demande/'.$notification->data['demande'])}}">
                            <i data-feather="eye"></i>
                        </a>
                        @endif

                        <form method="POST" action="{{url('patient/mark-as-read/'.$notification->id)}}" enctype="multipart/form-data"> {{csrf_field()}}
                        ...
                        <a class="me-2 btn btn-link" type="submit" href="{{url('patient/demandeCons/consulter/'.$notification->data['demande_infos'].'/'.$notification->id)}}">
                            <i data-feather="eye"></i>
                            Consulter
                        </a>
                        @endif
                        ...
                        <a class="me-2 btn btn-link" type="submit" href="{{url('patient/devis/'.$notification->data['invoice'].'/consulter/'.$notification->id)}}">
                            <i data-feather="eye"></i>
                            Consulter
                        </a>
                        @endif
