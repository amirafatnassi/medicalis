...
<div class="row">
  <div class="col-lg-2 col-3">
    <ul class="timeline">
      ...
      <a href="{{url('/patient/discussions/recu')}}" class="list-group-item list-group-item-action active">
    ...
    <div class="card mt-1">
      <div class="card-header">
        <div class="col-10 d-flex align-items-center">
          <span class="avatar">
            <img src="{{asset('uploads/users/'.($d->emetteur->image??'medecin.png'))}}" class="round" height="30" width="30" alt="" />
