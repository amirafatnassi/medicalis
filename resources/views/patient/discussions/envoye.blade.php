...
<div class="row">
  <div class="col-lg-2 col-3">
    <ul class="timeline">
      ...
      <a href="{{url('/patient/discussions/envoye')}}" class="list-group-item list-group-item-action active">
  ...
  <div class="col-lg-10 col-9">
    ...
    <div class="card mb-1">
      ...
      <div class="card-body">
        <h3> {{$d->type_courrier}}: {{$d->title}}
          <a href="{{url('patient/discussions/show',['slug'=>$d->slug])}}"><small>cliquez içi</small></a>
          <a href="#" class="badge badge-secondary">{{$d->replies->count()}}</a>
        </h3>
        <p>{!!Str::limit($d->content,200)!!}</p>
      </div>
