            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-notification mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                    ...
                                    <div class="media d-flex align-items-start">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <a class="me-2 btn btn-link" type="submit" href="{{url('coordinateurChef/demandeCons/consulter/'.$notification->data['demande_infos'].'/'.$notification->id)}}">
                        ...
                        <li class="dropdown-menu-footer"><a class="btn btn-primary btn-block" href="{{url('coordinateurChef/dashboard')}}">Lire toutes les notifications</a></li>
                    </ul>
                </li>
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="active" class="nav navbar-nav">
                        <a class="dropdown-toggle nav-link d-flex align-items-center" href="{{url('coordinateurChef/dossiers/index')}}"><i data-feather="bookmark"></i> Mes patients</a>
                    </li>
                    <li class="active" class="nav navbar-nav">
                    ...
                    <li class="active" class="nav navbar-nav">
                        <a class="dropdown-toggle nav-link d-flex align-items-center" href="{{url('/coordinateurChef/discussions/')}}"><i data-feather="users"></i>Discussions</a>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown">
                        <a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i data-feather="mail"></i><span data-i18n="UI Elements">Demandes de consultations</span></a>
                        <ul class="dropdown-menu">
                            <li class="active"><a class="dropdown-item d-flex align-items-center" href="{{url('coordinateurChef/demandeCons/index')}}" data-toggle="dropdown"><i data-feather="star"></i><span>Mes demandes de consultations</span></a>
                            </li>
                            <li class="active"><a class="dropdown-item d-flex align-items-center" href="{{url('coordinateurChef/demandeCons/enAttente')}}" data-toggle="dropdown"><i data-feather="mail"></i><span>Demandes de consultations en attente</span></a>
                            </li>
                            <li class="active"><a class="dropdown-item d-flex align-items-center" href="{{url('coordinateurChef/demandeCons/monequipe')}}" data-toggle="dropdown"><i data-feather="message-square"></i><span>Demandes de consultations mon équipe</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
