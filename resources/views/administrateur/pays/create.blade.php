...
@section('contenu')
<form method="POST" action="{{url('administrateur/pays/store')}}"> {{csrf_field()}}
    <div class="card">
        <div class="card-header">
            <div class="card-title">Nouveau Pays</div>
        </div>
        <div class="card-body row">
            ...
            <div class="col-12">
                <label for="lib"><b class="blueLabel">Code pays:</b></label>
