...
<div class="card">
    <table class="table align-middle mb-0 bg-white">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{url('representant/demandeCons/demande/'.$demande->id)}}" class="btn btn-outline-primary">ID:{{$demande->id}}</a>
                </td>
                <td class="align-middle">
                    @if($demande->status_id===1) <span class="badge badge-pill badge-light-danger">
                        @elseif($demande->status_id===2) <span class="badge badge-pill badge-light-success">
                            @elseif($demande->status_id===3) <span class="badge badge-pill badge-light-warning">
                                @elseif(($demande->status_id===4) || ($demande->status_id===5)) <span class="badge badge-pill badge-light-secondary">
                                    @elseif($demande->status_id===6) <span class="badge badge-pill badge-light-success">
                                        @elseif($demande->status_id===7) <span class="badge badge-pill badge-light-success">
                                            @elseif($demande->status_id===8) <span class="badge badge-pill badge-light-success">
                                                @elseif($demande->status_id===9) <span class="badge badge-pill badge-light-success">
