...
<div class="row">
    ...
    <div class="col-3">
        <a href="{{url('representant/medecins/create')}}" class="btn btn-outline-primary">
...
<table id="myTable" class="table table-striped">
    ...
    <tr class="list-goup-item">
        <td><a type="button" class="btn btn-outline-primary" href="{{url('representant/medecins/show',$med->id)}}"> {{$med -> id}}</a></td>
