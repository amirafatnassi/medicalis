            ...
            <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                <div class="user-avatar-section">
                    <div class="d-flex justify-content-start">
                        <img class="img-fluid rounded" src="{{asset('uploads/dossier/'.$dossier->image)}}" height="55" width="55" alt="User avatar" />
...
<div class="row">
    ...
    <div class="col-2">
        <a href="{{url('representant/dossiers/'.$dossier->id.'/consultations/create')}}" class="btn btn-outline-success">
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge badge-pill badge-light-primary mr-1">Saisie par {{$consultation->user}}</span></td>
                </tr>
                @endforeach
            </tbody>
        </table>
