...
<form method="POST" action="{{url('representant/dossiers/consultations/update/'.$consultation->id)}}" enctype="multipart/form-data"> {{csrf_field()}}
    <div class="row">
        <div class="col-12">
            <h5>
...
<script>
    ...
    function deleteData(id) {
        var id = id;
        //alert (id);
        var url = '{{route("representant.dossiers.consultations.deleteFile",":id")}}';
