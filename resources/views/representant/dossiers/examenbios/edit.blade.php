...
<form method="POST" action="{{url('representant/dossiers/examenbios/update/'.$examenbio->id)}}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <h5 class="blueLabel">
...
<script>
    ...
    function deleteData(id) {
        var id = id;
        var url = '{{route("representant.dossiers.examenbios.deleteFile",":id")}}';
