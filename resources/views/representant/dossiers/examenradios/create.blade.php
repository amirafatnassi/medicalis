...
<form method="POST" action="{{url('representant/dossiers/examenradios/store')}}" enctype="multipart/form-data"> @csrf
    <div class="row">
        <div class="col-12">
            <h5 class="blueLabel">
        ...
        <div class="col-12">
            <input type="hidden" value="{{$dossier[0]->id}}" name="dossier">
        </div>
        <div class="col-12">
