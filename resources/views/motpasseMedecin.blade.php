    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-forgot-password-form mt-2" method="POST" action="{{ url('motdepasseoubliemedecin')}}">{{csrf_field()}}
                    ...
                    <button type="submit" class="btn btn-primary btn-block" tabindex="2">Envoyer</button>
                </form>
                <p class="text-center mt-2"><a href="{{url('/loginMedecin')}}"><i data-feather="chevron-left"></i> Retour à login</a></p>
            </div>
        </div>
    </section>
