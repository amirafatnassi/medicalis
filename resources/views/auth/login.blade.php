    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <form method="POST" action="{{ route('login') }}">
          @csrf
          <div class="row mb-3">
            <label for="email" class="col-form-label text-md">{{ __('Email Address') }}</label>
          ...
          <div class="row mb-3">
            <label for="password" class="col-form-label text-md">{{ __('Password') }}</label>
        ...
        <p class="text-center mt-2"><span>Nouveau sur notre plateforme?</span><a href="{{url('/registre')}}"><span>&nbsp;Créer un compte</span></a></p>
      </div>
    </div>
  </section>
