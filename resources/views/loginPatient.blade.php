    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                <form class="auth-login-form mt-2" method="POST" action="{{ url('loginPatient')}}"> {{csrf_field()}}
                    <h4 class="card-title mb-1">Bienvenue à DMP ! 👋</h4>
                    <p class="card-text mb-2">Veuillez vous connecter à votre compte patient.</p>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{url('/motdepasseoubliepatient')}}">
                        ...
                        <div class="input-group input-group-merge form-password-toggle">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text cursor-pointer toggle-password" toggle="#pwd"><i data-feather="eye"></i></span>
                            </div>
                        </div>
                    </div>
                ...
                <p class="text-center mt-2"><span>Nouveau sur notre plateforme?</span><a href="{{url('/registrePatient')}}"><span>&nbsp;Créer un compte</span></a></p>
            </div>
        </div>
    </section>
