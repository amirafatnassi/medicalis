...
<div class="card">
    <form method="POST" action="{{url('medecin/examenbio/update/'.$examenbio->id)}}" enctype="multipart/form-data">@csrf
        <div class="card-header">
            <div class="card-title">Modifier examen bio</div>
        </div>
        <div class="card-body row">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <form action="{{ route('medecin.examenbio.deleteFile', $f->id) }}" method="POST" style="display:inline;"> {{ csrf_field() }} {{ method_field('DELETE') }}
