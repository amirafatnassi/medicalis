    ...
    <div class="col-xl-3 col-12 order-1 order-lg-1">
        <div class="card mb-1">
            ...
            <div class="card-body text-center">
                ...
                <div>
                    <a href="{{ url('medecin/'.$dossier->id.'/effetsmarquants')}}" class="btn btn-outline-primary">
                        <i data-feather="archive"></i>
                    </a>
                    <a href="{{url('medecin/forumMedPatient/createbyid/'.$dossier->id)}}" class="btn btn-outline-primary">
                        <i data-feather="message-square"></i>
                    </a>
                    <a href="{{ url('medecin/'.$dossier->id.'/historiques')}}" class="btn btn-outline-primary">
                        <i data-feather="clock"></i>
                    </a>
                    <a class="btn btn-outline-primary" href="{{url('medecin/edit/'.$dossier->id)}}">
    ...
    <div class="col-xl-6 col-12 order-2 order-lg-2">
        <div class="card">
            <div class="card-body d-flex justify-content-center">
                <a href="{{ url('medecin/'.$dossier->id.'/consultation')}}" class="btn btn-outline-secondary mr-1"><i data-feather="clipboard"></i> Consultations</a>
                <a href="{{ url('medecin/'.$dossier->id.'/examenbio')}}" class="btn btn-outline-secondary mr-1"><i data-feather="clipboard"></i> Examen bio</a>
                <a href="{{ url('medecin/'.$dossier->id.'/examenradio')}}" class="btn btn-outline-secondary"><i data-feather="clipboard"></i> Examen radio</a>
            </div>
        </div>
