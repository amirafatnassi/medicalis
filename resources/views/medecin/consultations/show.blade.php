...
<div class="card">
    ...
    @endif
    @if($consultation->observation_prive && $consultation->medecin_id==Auth::user()->id)
    ...
    <div class="card-footer row">
        @if (Auth::user()->id == $consultation->medecin_id)
        <a href="{{url('medecin/consultation/edit/'.$consultation->id)}}" class="btn  btn-block btn-primary">
