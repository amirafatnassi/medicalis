...
<form method="POST" action="{{url('medecin/consultation/store')}}" enctype="multipart/form-data"> {{csrf_field()}}
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-12">
                ...
                <input type="checkbox" class="form-check-input" name="effet_marquant" id="effet_marquant" value="1"  onclick="myFunction()">
...
<script>
    function myFunction() {
        var checkbox = document.getElementById("effet_marquant");
