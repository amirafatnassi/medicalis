...
<div class="row">
    <div class="col-lg-2 col-3">
        <ul class="timeline">
            ...
            <a href="{{url('/medecin/forum/envoyecloture')}}" class="list-group-item list-group-item-action active">
                <i data-feather="info" class="font-medium-3 mr-50"></i>
        ...
        <ul class="timeline">
            ...
            <div class="card mt-1">
                <div class="card-header row">
                    <div class="col-9">
                        <span class="avatar">
                            <img src="{{asset('uploads/users/'.($d->destinataire->image??'medecin.png'))}}" class="round" height="30" width="30" alt="" />
