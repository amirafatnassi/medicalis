...
<div class="row">
  ...
  <div class="col-lg-10 col-9">
    ...
    <div class="card">
      ...
      @endif
      <form method="POST" action="{{ url('medecin/forumMedPatient/reply', ['id' => $d->id]) }}" enctype="multipart/form-data"> @csrf
        <div class="card-header">
        ...
        <div class="card-footer">
          ...
          <a type="submit" class="btn btn-primary" href="{{ url('/medecin/forumMedPatient/cloturer', ['id' => $d->id]) }}" id="b_cloture">
