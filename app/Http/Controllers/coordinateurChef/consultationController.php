...
class consultationController extends Controller
{
    public function index($id_dossier)
    {
        ...
        return view('coordinateurChef.dossiers.consultations.index', [
            'dossier' => $dossier,
    ...
    public function create($id_dossier)
    {
        ...
        return view('coordinateurChef.dossiers.consultations.create', [
    ...
    public function edit($idC)
    {
        ...
        return view('coordinateurChef.dossiers.consultations.edit', [
            'liste_motif' => $liste_motif,
            'liste_meds' => $liste_meds,
    ...
    public function update(Request $request, $id)
    {
        ...
        $c->save();
        return  redirect('/coordinateurChef/dossiers/consultations/show/' . $id);
    }
    ...
    public function show($idC)
    {
        ...
        return view('coordinateurChef.dossiers.consultations.show', [
            'consultation' => $consultation,
            'dossier' => $dossier,
            'files' => $files
        ]);
    ...
    public function imprimer($id_dossier, $idC)
    {
        ...
        $date = date("d-m-Y");
        return view('coordinateurChef.dossiers.consultations.imprimer', [
    ...
    public function store(Request $request)
    {
        ...
        return  redirect('/coordinateurChef/dossiers/consultations/show/' . $consultation->id);
    }
    ...
    public function showExamenfiles($id)
    {
        ...
        return view('coordinateurChef.dossiers.consultations.files', [
            'files' => $files,
            'dossier' => $dossier
        ]);
    }
