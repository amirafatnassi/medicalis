...
class examenbioController extends Controller
{
    public function index($id_dossier)
    {
        ...
        return view('coordinateurChef.dossiers.examenbios.index', [
            'dossier' => $dossier,
    ...
    public function create($id_dossier)
    {
        ...
        $dossier = Dossier::findorfail($id_dossier);
        return view('coordinateurChef.dossiers.examenbios.create', [
            'dossier' => $dossier,
    ...
    public function edit($idC)
    {
        ...
        return view('coordinateurChef.dossiers.examenbios.edit', [
            'dossier' => $dossier,
            'examenbio' => $examenbio,
            'files' => $files,
            'liste_meds' => $liste_meds
    ...
    public function update(Request $request, $id)
    {
        ...
        return  redirect('/coordinateurChef/dossiers/examenbios/show/' . $id);
    }
    ...
    public function show($idC)
    {
        ...
        $dossier = Dossier::findorfail($examenbio->dossier);
        return view('coordinateurChef.dossiers.examenbios.show', [
            'dossier' => $dossier,
            'examenbio' => $examenbio,
            'files' => $files
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect('coordinateurChef/dossiers/examenbios/show/' . $examenbio->id);
    }
    ...
    public function showExamenfiles($idC)
    {
        ...
        $files = Exbiofiles::where('idexbio', '=', $idC)->get();
        return view('coordinateurChef.dossiers.examenbios.files', [
            'files' => $files,
            'dossier' => $dossier
        ]);
    }
