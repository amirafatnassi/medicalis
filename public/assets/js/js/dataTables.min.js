...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Precedent"},
sEmptyTable:"No data available in table",sInfo:"Vue de _START_ a _END_ de somme _TOTAL_ donnees",sInfoEmpty:"Vue de 0 a 0 de 0 donnees",sInfoFiltered:"(filtree de _MAX_ total donnees)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Vue _MENU_ donnees",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun Resultat"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
